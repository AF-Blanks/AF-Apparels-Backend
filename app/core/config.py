...
class Settings(BaseSettings):
    ...
    DEBUG: bool = False
    ALLOWED_ORIGINS: str = "http://localhost:3000,http://localhost:3001,https://af-apparel.vercel.app,https://af-apparel-sigma.vercel.app,https://af-apparels.vercel.app"
